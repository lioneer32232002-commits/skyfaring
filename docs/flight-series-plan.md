...
| # | 週次 | 狀態 | 題目 | 主要來源 |
|---|------|------|------|----------|
| 1 | 2026-08-14 當週 | in-progress（本機 session 撰寫中） | 驚嚇與意外反應（startle & surprise）：驚嚇後認知受損 30–90 秒 | [PMC narrative review](https://pmc.ncbi.nlm.nih.gov/articles/PMC10790839/) |
