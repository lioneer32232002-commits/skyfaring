...
excerpt: "設計出 ISBN 的人叫 Gordon Foster，1942 年被 MI6 招募進 Bletchley Park，做的是 Enigma 與德國海軍的 Shark。1965 年英國書商 W.H. Smith 要蓋電腦化倉庫，書業需要一組機器讀得懂的書號。他給的 9 碼 SBN 帶一個模 11 的檢查碼，能抓到所有單碼打錯與所有相鄰對調。2007 年 ISBN 為配合條碼改成 13 碼，這項偵錯能力就換掉了。"
highlight: "11 是質數，所以模 11 的加權和抓得到所有的單碼打錯，也抓得到所有的相鄰兩碼對調。2007 年 ISBN 為了跟 EAN-13 條碼相容改成模 10，相鄰對調的偵錯率從 100% 掉到 88.9%。"
